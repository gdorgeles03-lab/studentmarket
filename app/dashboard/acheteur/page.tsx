              ...
              <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 14, overflow: "hidden" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "18px 20px", borderBottom: "1px solid #e5e7eb" }}>
                  <div>
                    ...
                    <p style={{ fontSize: 12, color: "#9ca3af", marginTop: 3 }}>{commandesFiltrees.length} commande{commandesFiltrees.length > 1 ? "s" : ""}</p>
                  </div>
            ...
            <div>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24, flexWrap: "wrap", gap: 10 }}>
                <div>
                  ...
                  <p style={{ fontSize: 14, color: "#9ca3af" }}>{commandesFiltrees.length} commande{commandesFiltrees.length > 1 ? "s" : ""} au total</p>
                </div>
